...
// 📊 Dashboard / Stats Chart Icon
export const DashboardIcon = ({ size = 20, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 🏷️ Tag / Categories Icon
export const TagIcon = ({ size = 20, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// ✏️ Edit / Pencil Icon
export const EditIcon = ({ size = 16, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 🗑️ Trash / Delete Icon
export const TrashIcon = ({ size = 16, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 👥 Users / Visitors Icon
export const UsersIcon = ({ size = 20, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 👁️ Eye / Views Icon
export const EyeIcon = ({ size = 20, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 📅 Calendar Icon
export const CalendarIcon = ({ size = 20, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 📈 Trending / Analytics Icon
export const TrendingUpIcon = ({ size = 20, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 🚪 Logout / Door Icon
export const LogoutIcon = ({ size = 18, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// 🎨 Palette / Colors Icon
export const ColorPaletteIcon = ({ size = 20, style, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
